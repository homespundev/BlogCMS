...
namespace HomespunClassics.UI.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentID,UserID,DateCreated,CommentBody,CommentTitle,PostID")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentID,UserID,DateCreated,CommentBody,CommentTitle,PostID")] Comment comment)
        {
            if (ModelState.IsValid)
            {
